...
import com.example.gymapplication.EmployeeActivities.EmployeeHomeActivity;
...
String ip = "10.0.2.2:80";
    ...
    public void loginBtnClick(View view) {
        ...
        String URL = "http://"+ip+"/gymproject/user/login.php?enteredUsername=" + enteredUsername + "&enteredPassword=" + enteredPassword;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.contains("manager")) {
                            ...
                            Intent intent = new Intent(getApplicationContext(), com.example.gymapplication.ManagerActivities.MangerMainActivity.class);
                        ...
                        /* start employee interface */
                            ...
                            int id = Integer.parseInt(split[1]);
                            System.out.println(id);
                            Intent intent = new Intent(getApplicationContext(), EmployeeHomeActivity.class); //EmployeeHomeActivity
                            intent.putExtra("id",id+"");
                            intent.putExtra("username",enteredUsername);
                            intent.putExtra("password",enteredPassword);
                            startActivity(intent);
